    ...
    <div>
        ...
        <form>
            <div className="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    <label  className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-900">Company</label>
                ...
                <div>
                    <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-900">Phone number</label>
                ...
                <div>
                    <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-900">Website URL</label>
                ...
                <div>
                    <label  className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-900">Unique visitors (per month)</label>

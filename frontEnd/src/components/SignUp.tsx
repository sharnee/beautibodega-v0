    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 h-screen w-full font-Caslon antialiased'>
        ...
        <div className=' flex flex-col justify-center lg:pl-52 '>
            ...
            <div className='flex flex-col text-gray-500 py-2 text-sm'>
                    <label>Name</label>
                    <input name="email" className='rounded-lg border-2 border-zinc-500 mt-2 p-2 focus:border-gray-200 ' type="text" required onChange={(e)=>setName(e.target.value)}/>
                </div>
                <div className='flex flex-col text-gray-500 py-2 text-sm'>
                    <label>Email</label>
                    <input name="email" className='rounded-lg border-2 border-zinc-500 mt-2 p-2 focus:border-gray-200 ' type="email" required onChange={(e)=>setEmail(e.target.value)}/>
                </div>
                <div className='flex flex-col text-gray-500 py-2 text-sm'>
                    <label>Password</label>
                    <input name="password" className='p-2 rounded-lg border-2 border-zinc-500 mt-2 focus:border-gray-200  ' type="password" required onChange={(e)=>setPassword(e.target.value)}/>
                </div>
                <div className='flex flex-col text-gray-500 py-2 text-sm'>
                    <label >Re-Enter Password</label>
                    <input className='p-2 rounded-lg border-2 border-zinc-500 mt-2 focus:border-gray-200  ' type="password" required onChange={(e)=>setRePassword(e.target.value)}/>
                </div>
